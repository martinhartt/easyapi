...
const ServiceSetupSpreadsheet = ({ text, onChange, onDone, annotations, nextEnabled }) => (
  <div>
...
ServiceSetupSpreadsheet.PropTypes = {
...
export default Radium(ServiceSetupSpreadsheet);
